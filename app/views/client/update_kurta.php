			...
			<div class="col-lg-6">
				...
				<div class="form-group row">
					...
					<div class="col-lg-7">
						...
						value="<?php echo find_return($kurta['lambai'], 2);?>" placeholder="<?php echo lang('placeholder_lambai');?>">
						<span class="validation_error">
							<?php echo form_error('lambai');?>
						</span>
					</div>
					<div class="col-lg-3">
						<input type="text" value="<?php echo find_return($kurta['lambai']);?>" class="form-control" placeholder="e.g 1/2,1/4" name="lambai-x" />
					</div>
				</div>
				<div class="form-group row">
					...
					<div class="col-lg-7">
						...
						type="text" value="<?php echo find_return($kurta['mora'], 2);?>" placeholder="<?php echo lang('placeholder_mora');?>">
						<span class="validation_error">
							<?php echo form_error('mora');?>
						</span>
					</div>
					<div class="col-lg-3">
						<input type="text" value="<?php echo find_return($kurta['mora']);?>" class="form-control" placeholder="e.g 1/2,1/4" name="mora-x" />
					</div>
				</div>
				<div class="form-group row">
					...
					<div class="col-lg-7">
						...
						type="text" value="<?php echo find_return($kurta['shoulder'], 2);?>" placeholder="<?php echo lang('placeholder_shoulder');?>">
						<span class="validation_error">
							<?php echo form_error('shoulder');?>
						</span>
					</div>
					<div class="col-lg-3">
						<input type="text" value="<?php echo find_return($kurta['shoulder']);?>" class="form-control" placeholder="e.g 1/2,1/4" name="shoulder-x" />
					</div>
				</div>
				<div class="form-group row">
					...
					<div class="col-lg-7">
						...
						type="text" value="<?php echo find_return($kurta['chatti'], 2);?>" placeholder="<?php echo lang('placeholder_chatti');?>">
						<span class="validation_error">
							<?php echo form_error('chatti');?>
						</span>
					</div>
					<div class="col-lg-3">
						<input type="text" value="<?php echo find_return($kurta['chatti']);?>" class="form-control" placeholder="e.g 1/2,1/4" name="chatti-x" />
					</div>
				</div>
				<div class="form-group row">
					...
					<div class="col-lg-7">
						...
						value="<?php echo find_return($kurta['tera'], 2);?>" placeholder="<?php echo lang('placeholder_tera');?>">
						<span class="validation_error">
							<?php echo form_error('tera');?>
						</span>
					</div>
					<div class="col-lg-3">
						<input type="text" value="<?php echo find_return($kurta['chatti']);?>" class="form-control" placeholder="e.g 1/2,1/4" name="tera-x" />
					</div>
				</div>
				<div class="form-group row">
					...
					<div class="col-lg-7">
						...
						value="<?php echo find_return($kurta['collar'], 2);?>" placeholder="<?php echo lang('placeholder_collar');?>">
						<span class="validation_error">
							<?php echo form_error('collar');?>
						</span>
					</div>
					<div class="col-lg-3">
						<input type="text" value="<?php echo find_return($kurta['collar']);?>" class="form-control" placeholder="e.g 1/2,1/4" name="collar-x" />
					</div>
				</div>
				<div class="form-group row">
					...
					<div class="col-lg-7">
						...
						value="<?php echo find_return($kurta['asteen'], 2);?>" placeholder="<?php echo lang('placeholder_asteen');?>
						">
						<span class="validation_error">
					...
					<div class="col-lg-3">
						<input type="text" value="<?php echo find_return($kurta['asteen']);?>" class="form-control" placeholder="e.g 1/2,1/4" name="asteen-x" />
					</div>
				</div>
				<div class="form-group row">
					...
					<div class="col-lg-7">
						...
						value="<?php echo find_return($kurta['daman'], 2);?>" placeholder="<?php echo lang('placeholder_daman');?>">
						<span class="validation_error">
							<?php echo form_error('daman');?>
						</span>
					</div>
					<div class="col-lg-3">
						<input type="text" value="<?php echo find_return($kurta['daman']);?>" class="form-control" placeholder="e.g 1/2,1/4" name="daman-x" />
					</div>
				</div>
				<div class="form-group row">
					...
					<div class="col-lg-7">
						...
						value="<?php echo find_return($kurta['shalwar'], 2);?>" placeholder="<?php echo lang('placeholder_shalwar');?>">
						<span class="validation_error">
							<?php echo form_error('shalwar');?>
						</span>
					</div>
					<div class="col-lg-3">
						<input type="text" value="<?php echo find_return($kurta['shalwar']);?>" class="form-control" placeholder="e.g 1/2,1/4" name="shalwar-x" />
					</div>
				</div>
				<div class="form-group row">
					...
					<div class="col-lg-7">
						...
						value="<?php echo find_return($kurta['pancha'], 2);?>" placeholder="<?php echo lang('placeholder_pancha');?>">
						<span class="validation_error">
							<?php echo form_error('pancha');?>
						</span>
					</div>
					<div class="col-lg-3">
						<input type="text" value="<?php echo find_return($kurta['pancha']);?>" class="form-control" placeholder="e.g 1/2,1/4" name="pancha-x" />
					</div>
				</div>
