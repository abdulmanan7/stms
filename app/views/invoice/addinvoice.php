<?php $this->load->view('partial/panel-start-simple');?>
                    ...
                    <div class="form-group">
                        <label class="col-md-2 control-label" for="client_id"><?php echo lang('name_label');?></label>
                        <div class="col-md-8">
                            <?php echo form_dropdown('client_id', $clients, $selected_client, 'class="form-control selectize-select" placeholder=' . '"' . lang('placeholder_name') . '"' . "'");?>
                        </div>
                    </div>
                    <!-- Client Dd Closed -->
...
<script>
    ...
    function autoField(){
        $(".product").autocomplete({
            source: '<?php echo base_url("invoice/get_products");?>',
