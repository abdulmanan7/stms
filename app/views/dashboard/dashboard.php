...
<?php else: ?>
	...
	<div class="col-sm-5 action">
		<a class='btn btn-info btn-xs' href='<?php echo base_url("client/view/" . $client['id']);?>'>
			<i class='icon-folder-open'></i>
		</a>
		<a class='btn btn-success btn-xs' href='<?php echo base_url("client/update/" . $client['id']);?>'>
			<i class='icon-edit'></i>
		</a>
		<a class='btn btn-danger btn-xs' href='<?php echo base_url("relation/remove/" . $client['id']);?>'>
